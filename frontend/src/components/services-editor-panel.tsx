...
import { useServicesPageConfig } from "@/hooks/use-services-page-config";
...
const SECTION_OPTIONS: SectionOption[] = defaultServicesPageConfig.sections.map(
  (section) => ({
    id: section.id,
...
export function ServicesEditorPanel() {
  ...
  const { config, saveField } = useServicesPageConfig();
  const [selectedSectionId, setSelectedSectionId] =
    useState<string>("jcw-main-services-hero01");
