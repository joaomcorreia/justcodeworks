...
export default function RestaurantFooter({ site }: FooterProps) {
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-red-100 mb-4">
              ...
              Experience traditional flavors prepared with love and passion.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-red-100">
              ...
              <li className="text-red-300 font-semibold">Closed on Tuesdays</li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-8 pt-8 border-t border-red-800">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-center md:text-left">
            <div className="flex items-center justify-center md:justify-start">
              ...
              <span className="text-red-100">(555) 123-4567</span>
            </div>
            <div className="flex items-center justify-center md:justify-start">
              <svg className="w-5 h-5 mr-2 text-red-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
              </svg>
              <span className="text-red-100">info@marysrestaurant.com</span>
            </div>
            <div className="flex items-center justify-center md:justify-start">
              <svg className="w-5 h-5 mr-2 text-red-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <span className="text-red-100">123 Main Street, Downtown</span>
            </div>
          </div>
        </div>

        {/* Copyright */}
        <div className="mt-8 pt-8 border-t border-red-800 text-center">
