...
export default function AutoGarageHeroSection({ section, mode = 'public' }: SectionProps) {
  ...
  return (
    <section className="relative min-h-screen flex items-center bg-gray-100 text-gray-900 overflow-hidden">
      {/* Background Image */}
      {backgroundImage && (
        <div 
      ...
      <div className="relative z-10 container mx-auto px-4 max-w-7xl">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          <div className="lg:col-span-7">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-8">
              ...
              <a
                ...
                className="inline-flex items-center justify-center px-8 py-3 border border-red-500 text-base font-medium rounded-md text-red-500 bg-transparent hover:bg-red-500 hover:text-white transition-colors duration-200"
              >
                <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="lg:col-span-5 lg:col-start-8">
            <div className="bg-gray-900 bg-opacity-80 backdrop-blur-sm rounded-lg p-6 border border-gray-600 text-white">
              ...
              {phone && (
                <div className="flex items-center space-x-3 mb-3">
                  ...
                  <div>
                    ...
                    <a href={`tel:${phone}`} className="font-semibold hover:text-blue-300 transition-colors text-white">
                      {phone}
                    </a>
                  </div>
                </div>
